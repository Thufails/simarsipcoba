    ...
    if ($arsips->isNotEmpty()) {
        ...
        $formattedPermissions = $permissions->map(function ($permission) use ($arsips) {
            ...
            if ($arsip) {
                ...
                $firstArsip = $formattedArsips->first();

                $formattedPermission['NAMA_DOKUMEN'] = $firstArsip['NAMA_DOKUMEN'];
                $formattedPermission['NO_DOKUMEN'] = $firstArsip['NO_DOKUMEN'];
                $formattedPermission['NAMA'] = $firstArsip['NAMA'];
            }
